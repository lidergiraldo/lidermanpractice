 ...
 */
package com.lidermanpractice.core.models;
...
import com.lidermanpractice.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "lidermanpractice/components/helloworld");
